# Mission Orchestrator — Build spec (for Claude Code)

Public GitHub landing page: [README.md](README.md).
...
and recommends the least-bad reassignment — the operator decides, the system commits. This file is
